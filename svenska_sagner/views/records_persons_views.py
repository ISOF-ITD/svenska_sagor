...
class RecordsPersonsListView(ListView):
    ...
    template_name = "svenska_sagner/records_persons_list.html"
    paginate_by = 20
...
class RecordsPersonsDetailView(DetailView):
    model = RecordsPersons
    template_name = "svenska_sagner/records_persons_detail.html"
...
class RecordsPersonsCreateView(CreateView):
    ...
    template_name = "svenska_sagner/records_persons_create.html"
...
class RecordsPersonsUpdateView(UpdateView):
    ...
    form_class = RecordsPersonsForm
    # fields = ['record', 'person', 'relation']
    template_name = "svenska_sagner/records_persons_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class RecordsPersonsDeleteView(DeleteView):
    model = RecordsPersons
    template_name = "svenska_sagner/records_persons_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "records_persons"
