...
class MediaListView(ListView):
    model = Media
    template_name = "svenska_sagner/media_list.html"
    paginate_by = 20
...
class MediaDetailView(DetailView):
    model = Media
    template_name = "svenska_sagner/media_detail.html"
...
class MediaCreateView(CreateView):
    ...
    # fields = ['source', 'type']
    template_name = "svenska_sagner/media_create.html"
...
class MediaUpdateView(UpdateView):
    ...
    form_class = MediaForm
    # fields = ['source', 'type']
    template_name = "svenska_sagner/media_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class MediaDeleteView(DeleteView):
    model = Media
    template_name = "svenska_sagner/media_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "media"
