...
class PersonsPlacesListView(ListView):
    model = PersonsPlaces
    template_name = "svenska_sagner/persons_places_list.html"
    paginate_by = 20
...
class PersonsPlacesDetailView(DetailView):
    model = PersonsPlaces
    template_name = "svenska_sagner/persons_places_detail.html"
...
class PersonsPlacesCreateView(CreateView):
    ...
    template_name = "svenska_sagner/persons_places_create.html"
...
class PersonsPlacesUpdateView(UpdateView):
    ...
    form_class = PersonsPlacesForm
    # fields = ['person', 'place', 'relation']
    template_name = "svenska_sagner/persons_places_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class PersonsPlacesDeleteView(DeleteView):
    model = PersonsPlaces
    template_name = "svenska_sagner/persons_places_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "persons_places"
