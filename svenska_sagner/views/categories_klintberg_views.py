...
class CategoriesKlintbergListView(ListView):
    ...
    template_name = "svenska_sagner/categories_klintberg_list.html"
    paginate_by = 20
...
class CategoriesKlintbergDetailView(DetailView):
    model = CategoriesKlintberg
    template_name = "svenska_sagner/categories_klintberg_detail.html"
...
class CategoriesKlintbergCreateView(CreateView):
    ...
    template_name = "svenska_sagner/categories_klintberg_create.html"
...
class CategoriesKlintbergUpdateView(UpdateView):
    ...
    form_class = CategoriesKlintbergForm
    # fields = ['name', 'name_en', 'level']
    template_name = "svenska_sagner/categories_klintberg_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class CategoriesKlintbergDeleteView(DeleteView):
    model = CategoriesKlintberg
    template_name = "svenska_sagner/categories_klintberg_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "categories_klintberg"
