...
class SockenV1ListView(ListView):
    model = SockenV1
    template_name = "svenska_sagner/socken_v1_list.html"
    paginate_by = 20
...
class SockenV1DetailView(DetailView):
    model = SockenV1
    template_name = "svenska_sagner/socken_v1_detail.html"
...
class SockenV1CreateView(CreateView):
    ...
    template_name = "svenska_sagner/socken_v1_create.html"
...
class SockenV1UpdateView(UpdateView):
    ...
    form_class = SockenV1Form
    # fields = ['name', 'harad', 'lat', 'lng', 'changedate']
    template_name = "svenska_sagner/socken_v1_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class SockenV1DeleteView(DeleteView):
    model = SockenV1
    template_name = "svenska_sagner/socken_v1_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "socken_v1"
