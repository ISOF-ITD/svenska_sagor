...
class CategoriesListView(ListView):
    model = Categories
    template_name = "svenska_sagner/categories_list.html"
    paginate_by = 20
...
class CategoriesDetailView(DetailView):
    model = Categories
    template_name = "svenska_sagner/categories_detail.html"
...
class CategoriesCreateView(CreateView):
    ...
    # fields = ['name', 'name_en']
    template_name = "svenska_sagner/categories_create.html"
...
class CategoriesUpdateView(UpdateView):
    ...
    form_class = CategoriesForm
    # fields = ['name', 'name_en']
    template_name = "svenska_sagner/categories_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class CategoriesDeleteView(DeleteView):
    model = Categories
    template_name = "svenska_sagner/categories_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "categories"
