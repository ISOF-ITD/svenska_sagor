...
class RecordsCategoryListView(ListView):
    ...
    template_name = "svenska_sagner/records_category_list.html"
    paginate_by = 20
...
class RecordsCategoryDetailView(DetailView):
    model = RecordsCategory
    template_name = "svenska_sagner/records_category_detail.html"
...
class RecordsCategoryCreateView(CreateView):
    ...
    template_name = "svenska_sagner/records_category_create.html"
...
class RecordsCategoryUpdateView(UpdateView):
    ...
    form_class = RecordsCategoryForm
    # fields = ['record', 'category', 'level', 'type']
    template_name = "svenska_sagner/records_category_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class RecordsCategoryDeleteView(DeleteView):
    model = RecordsCategory
    template_name = "svenska_sagner/records_category_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "records_category"
