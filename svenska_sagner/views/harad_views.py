...
class HaradListView(ListView):
    model = Harad
    template_name = "svenska_sagner/harad_list.html"
    paginate_by = 20
...
class HaradDetailView(DetailView):
    model = Harad
    template_name = "svenska_sagner/harad_detail.html"
...
class HaradCreateView(CreateView):
    ...
    template_name = "svenska_sagner/harad_create.html"
...
class HaradUpdateView(UpdateView):
    ...
    form_class = HaradForm
    # fields = ['name', 'lan', 'landskap', 'country']
    template_name = "svenska_sagner/harad_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class HaradDeleteView(DeleteView):
    model = Harad
    template_name = "svenska_sagner/harad_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "harad"
