...
class RecordsForm(forms.ModelForm):
    ...
    def clean_informant_name(self):
        informant_name = self.cleaned_data.get("informant_name", None)
...
class SockenForm(forms.ModelForm):
    ...
    def clean_sweref99_n(self):
        sweref99_n = self.cleaned_data.get("sweref99_n", None)
        return sweref99_n

    def clean_sweref99_e(self):
        sweref99_e = self.cleaned_data.get("sweref99_e", None)
        return sweref99_e
