# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2019-07-23 15:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('sägner', 'Sägner'), ('frågelista', 'Frågelista'), ('webbfrågelista', 'Webbfrågelista'), ('matkarta', 'Matkarta'), ('digitalt-kulturarv', 'Digitalt kulturarv')], max_length=255)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archive_id', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            name='TranscribedRecordsCategory',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.ForeignKey(db_column='category', on_delete=django.db.models.deletion.CASCADE, to='Sagenkarta-Admin.Categories')),
                ('record', models.ForeignKey(db_column='record', on_delete=django.db.models.deletion.CASCADE, to='Sagenkarta-Admin.TranscribedRecords')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TranscribedRecordsPersons',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation', models.CharField(blank=True, choices=[('i', 'Informant'), ('c', 'Uppteckare'), ('sender', 'Avsändare'), ('receiver', 'Mottagare'), ('recorder', 'Intervjuare')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            name='TranscribedRecordsPlaces',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('place_collected', 'Insamlingsort'), ('place_mentioned', 'Nämns i texten'), ('related_person_place', 'Födelseort/hemort'), ('dispatch_place', 'Avsändningsort'), ('destination_place', 'Destination')], default='place_collected', max_length=20, null=True)),
                ('place', models.ForeignKey(db_column='place', on_delete=django.db.models.deletion.CASCADE, to='Sagenkarta-Admin.Socken')),
                ('record', models.ForeignKey(db_column='record', on_delete=django.db.models.deletion.CASCADE, to='Sagenkarta-Admin.TranscribedRecords')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='transcribedrecords',
            name='categories',
            field=models.ManyToManyField(through='Sagenkarta-Admin.TranscribedRecordsCategory', to='Sagenkarta-Admin.Categories', verbose_name='Kategorier'),
        ),
        migrations.AddField(
            model_name='transcribedrecords',
            name='person_objects',
            field=models.ManyToManyField(through='Sagenkarta-Admin.TranscribedRecordsPersons', to='Sagenkarta-Admin.Persons', verbose_name='Personer'),
        ),
        migrations.AddField(
            model_name='transcribedrecords',
            name='places',
            field=models.ManyToManyField(through='Sagenkarta-Admin.TranscribedRecordsPlaces', to='Sagenkarta-Admin.Socken', verbose_name='Socken'),
        ),
