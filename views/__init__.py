...
from .persons_places_views import *  # NOQA
from .socken_v1_views import *  # NOQA
from .records_media_views import *  # NOQA
from .socken_views import *  # NOQA
from .categories_views import *  # NOQA
from .harad_views import *  # NOQA
